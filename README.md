today is 19March, restarting experiments with colors / but using python, dont want to spin a new repositry so, will archive the master brnach with julia progress and 
